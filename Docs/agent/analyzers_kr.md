...
여기 있는 규칙은 전부 `cautions_kr.md`의 항목 중 **컴파일은 되지만 부하가 걸려야 터지는** 것들이다.
...
전부 기본 심각도가 **Warning**이다. 자세한 배경은 [cautions_kr.md](cautions_kr.md).
...
**애널라이저는 안전망이지 검사기가 아니다.** [cautions_kr.md](cautions_kr.md)의 리뷰 체크리스트를 같이 쓴다.
