...
#pragma warning disable CS8601
    ...
    public bool TryGet(out T item)
    {
        ...
        // Use Interlocked to guarantee a full memory barrier: all Push() calls inside
        // IncreaseCapacity() must be visible to other threads before they observe
        // m_IsIncreasing == 0 and attempt to pop the newly added items.
